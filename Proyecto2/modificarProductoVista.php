<?php
  ...
  $nombreVendedor = isset($_GET['nombreVendedor']) ? $_GET['nombreVendedor'] : '';
  ...
  <main>
    <div class="formulario-container">
        ...
        <div class="formulario-content">
          <div class="bg-form-add-prod-img">
            <h1>Escriba los datos del producto a modificar</h1>
          </div>
          
          <form id="formulario" action="modificarProductos.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nombreVendedor" name="nombreVendedor" value="<?php echo $nombreVendedor; ?>">
            </div>
            <div class="mb-3">
              <label for="precio" class="form-label">Precio</label>
              <input type="number" class="form-control" id="precio" name="precio" step="0.01" value="<?php echo $precio; ?>">
            </div>
            <div class="mb-3">
